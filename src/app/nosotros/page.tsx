  ...
  return (
    <div className="container-nb py-20 grid md:grid-cols-2 gap-16 items-center">
      <div className="relative aspect-[4/5] overflow-hidden">
        <Image src="/images/ambientes/living.svg" alt="Ambiente Nubari" fill className="object-cover" />
      </div>
      <div>
        <p className="text-xs tracking-widest2 text-nb-wood mb-4">NUESTRA ESENCIA</p>
        <h1 className="font-serif text-4xl text-nb-black leading-tight">
          Diseñamos muebles para vivirlos.
        </h1>
        <p className="mt-6 text-nb-stone leading-relaxed">
